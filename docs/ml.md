...
**Порядок пайплайна:** classify (3) → **smooth (3b)** → identify (4). identify видит уже
сглаженную раскладку. ⚠️ 3b владеет `labels.json` живого инференса (модель+сглаживание) — ручную
разметку под датасет вести на СНАПШОТЕ (копии каталога), иначе 3b затрёт правки.
